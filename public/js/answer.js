function createQuestionBox(profilePicUrl, userProfile, questionDescription) {
  ...
  img.src = profilePicUrl; // Replace with actual URL
  ...
  answerForm.addEventListener("submit", function (event) {
    ...
    // You can handle the answer submission here (e.g., send it to the server)
  ...
  postActions.appendChild(answerForm);
